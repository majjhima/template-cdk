...
## Project
Single-stack AWS CDK TypeScript app. One Lambda (`src/hello-cdk.ts`) exposed via Function URL, defined in `lib/template-cdk-stack.ts`. CDK app entry is `bin/template-cdk.ts`.
